...
_glriflemag_tr = "CUP_30Rnd_545x39_AK_M";
...
// Marksman rifle
_DMrifle = "CUP_arifle_FNFAL";
_DMriflemag = "CUP_20Rnd_762x51_FNFAL_M";
...
// Ghillie
_ghillieUniform = ["U_BG_leader","U_BG_Guerilla1_1","U_BG_Guerilla2_1","U_BG_Guerilla2_2","U_BG_Guerilla2_3","U_BG_Guerilla3_1","U_BG_Guerilla3_2","U_BG_Guerrilla_6_1"];	//DLC alternatives: ["U_B_FullGhillie_lsh","U_B_FullGhillie_ard","U_B_FullGhillie_sard"];
_ghillieHelmet = ["H_Shemag_olive","H_ShemagOpen_tan","H_Bandanna_khk","H_Booniehat_khk","H_Cap_oli","H_Watchcap_blk"];
_ghillieRig = ["V_TacVest_blk","V_TacVest_camo","V_TacVest_oli"];
...
// LOADOUT: MEDIUM AT GUNNER
	case "matg":
	{
		...
		_unit additem "CUP_optic_PGO7V3";
	};
